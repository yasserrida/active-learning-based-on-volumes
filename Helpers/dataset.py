...
def get_MNIST():
    raw_tr = datasets.MNIST('./Datasets/MNIST', train=True, download=True)
    raw_te = datasets.MNIST('./Datasets/MNIST', train=False, download=True)
...
def get_SVHN():
    data_tr = datasets.SVHN('./Datasets/SVHN', split='train', download=True)
    data_te = datasets.SVHN('./Datasets/SVHN', split='test', download=True)
    X_tr = data_tr.data
